...
swagger_kwargs = {
    ...
    "skill_get": {
        ...
        "responses": {200: CandidateProfessionalSkillGetSerializer()}},
    "skill_post": {
        "methods": ["POST", "PATCH"],
        "request_body": CandidateProfessionalSkillSerializer,
        "responses": {200: CandidateProfessionalSkillSerializer()}},
    "skill_delete": {
        "method": "DELETE",
    },
    "job_preference_get": {
    ...
    "user":{"method": "PATCH",
        "request_body": CandidatePatchSerializer,
        "responses": {200: CandidatePatchSerializer()}},
    "my_announcements": {
        "method": "GET",
        "responses": {200: CandidateAnnouncementListSerializer()}},
